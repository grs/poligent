...
Router.prototype.update_entity = function (type, name, attributes) {
    return this.request('UPDATE', {'type':type, 'name':name}, attributes || {});
};
...
function add_updatable_resource_type (name, typename, plural) {
    add_resource_type(name, typename, plural);
    var resource_type = typename || name;
    Router.prototype['update_' + name] = function (o) {
        return this.update_entity(resource_type, o.name, o);
    };
}
...
add_updatable_resource_type('vhost');
